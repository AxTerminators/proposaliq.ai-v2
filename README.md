...
At the time that I was using B44, it was not mature enough for me, so I moved to use more mature tools.
...
Currently, it is using B44 API LLM integration which will not work. You'll need to code in your own integration to one of the LLM models.
