...
/**
 * ProposalStrategyConfigPage - Safe wrapper for Phase5
 * 
 * This page:
 ...
 * - Passes organizationId as prop to Phase5 (avoiding org fetch issues)
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50">
        <Card className="border-none shadow-xl max-w-md w-full">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-slate-600 text-lg">Loading strategy configuration...</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Phase5 Component with safe props */}
        <Phase5
          proposalData={proposal}
          setProposalData={() => {}} // No-op for now, Phase5 saves directly
          proposalId={proposalId}
          organizationId={organization.id} // Pass organizationId to avoid fetch issues
