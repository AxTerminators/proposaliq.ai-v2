    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">Loading proposal writer...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Phase6
          ...
          onNavigateToPhase={(phaseId) => {
            // Navigate back to builder with the selected phase
            navigate(createPageUrl("ProposalBuilder") + `?id=${proposalId}&phase=${phaseId}`);
          }}
