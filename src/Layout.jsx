              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    to={item.url}
                    className={cn(
                      "flex items-center hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 rounded-lg",
              ...
              <nav className="space-y-1">
                {adminItems.map((item) => (
                  <Link
                    ...
                    to={item.url}
                    className={cn(
                      "flex items-center hover:bg-red-50 hover:text-red-700 transition-all duration-200 rounded-lg",
