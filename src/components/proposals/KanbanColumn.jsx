  ...
  return (
    <div
      className={cn(
        ...
        isMagnetic && !snapshot.isDraggingOver && canDragToHere && "border-blue-300 border-dashed bg-blue-50 shadow-md scale-[1.01]"
      )}
    >
      {/* Column Header */}
      <div
      ...
      <div
        ...
        className={cn(
          ...
          isMagnetic && !snapshot.isDraggingOver && canDragToHere && "bg-blue-50/30"
        )}
      >
