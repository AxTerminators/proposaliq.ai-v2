...
export default function Phase6({ proposalData, proposalId }) {
        ...
        <CardHeader className="border-b">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
              ...
              <CardDescription>Generate and edit proposal sections with AI assistance using your strategy settings</CardDescription>
            </div>
            ...
            <TabsContent value="generator" className="space-y-4">
              <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200">
                <CardHeader>
                  ...
                  <CardDescription>Generate common proposal sections - AI will use your strategy settings and reference documents</CardDescription>
                </CardHeader>
                <CardContent>
