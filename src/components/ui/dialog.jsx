    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close 
          className="absolute right-2 top-2 md:right-4 md:top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 data-[state=open]:text-slate-500 min-h-[44px] min-w-[44px] flex items-center justify-center z-10"
