...
export default function ResourceManager({ organization, user, trigger }) {
  ...
  const getResourceAvailability = (resource, dateTime) => {
    ...
    const overlappingBookings = resourceBookings.filter(booking => {
      ...
      return dateTime.isBetween(bookingStart, bookingEnd, null, '[)');
    });

    return {
      available: overlappingBookings.length < resource.capacity,
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h4 className="font-semibold text-slate-900">Your Resources</h4>
              <Button size="sm" onClick={() => { resetResourceForm(); setEditingResource(null); }}>
            ...
            {editingResource === null ? (
              ...
              <div className="space-y-4 bg-slate-50 p-6 rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={resourceData.booking_rules?.requires_approval}
